...
parser.add_argument('--name',default='ft_net_swin', type=str, help='output model name')
...
parser.add_argument('--use_swin', action='store_true', help='use swin transformer 224x224', default= True )
